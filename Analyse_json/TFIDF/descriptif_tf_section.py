...
# Configuration
output_dir = "/home/loris/Stage/STAGE/Test/db_sortie_block/DOC/analysis/TFIDF/Section"
...
def build_intersection_tfidf_analysis(studies, sections=['SUMMARY','SCIENTIFIC JUSTIFICATION','OBJECTIVES','METHODOLOGY','PROCEDURE','ELIGIBILITY','DATA MANAGEMENT','STATISTICAL']):
    ...
    for idx, section in enumerate(valid_sections):
        ...
        plt.tight_layout()
        plt.savefig(f'{output_dir}/tfidf_intersection_top_{section.lower()}.png')
        plt.close()
        
        word_freq.to_csv(f'{output_dir}/tfidf_intersection_{section.lower()}.csv', index=False)
