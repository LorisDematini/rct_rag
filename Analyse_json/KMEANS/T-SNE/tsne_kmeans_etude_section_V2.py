...
def cluster_study_sections_with_tsne(X_tfidf, labels, texts, vectorizer, n_clusters=6):
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig(f"{output_dir}/Kmeans_etude_sections_V2.png")
    plt.close()
    ...
    csv_path = os.path.join(output_dir, "kmeans_etude_section_V2.csv")
