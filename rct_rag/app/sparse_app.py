...
7. Affiche les résultats de la recherche et de top termes avec `display_sparse_results()`.

Ce moteur permet une recherche par similarité, en utilisant TF-IDF pour trouver les sections les plus proches de la requête en termes de contenu.
'''
