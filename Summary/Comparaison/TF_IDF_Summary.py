...
def save_tfidf_matrix(tfidf_matrix, vectorizer, labels, file_path='/home/loris/Stage/STAGE/Test/db_sortie_block/DOC/Summary/Comparaison/tfidf_matrix_l1.csv'):
...
def save_query_vector(query, vectorizer, file_path='/home/loris/Stage/STAGE/Test/db_sortie_block/DOC/Summary/Comparaison/query_vector_l1.csv'):
